...
VALUES ((UUID_TO_BIN('320f0294-3a0a-4a04-afbe-123078da99c8')), 1, '2023-09-20 14:15:00', 27397, 21, 80, 17.92, 45.96, 1),
       ...
       ((UUID_TO_BIN('8417430c-3493-46fa-a607-ff2a2e538dc1')), 1, '2023-10-18 02:00:00', 29721, 60, 79, 0.00, 19.77, 4),
       ((UUID_TO_BIN('d9f5d138-28b6-4d31-a3cb-4e5c3f210c7c')), 1, '2023-10-18 08:30:00', 29862, 33, 55, 0.00, 19.76, 4),
       ((UUID_TO_BIN('06c412d6-701e-4e5e-a28b-f8c5830a24ba')), 1, '2023-10-18 15:00:00', 29880, 50, 83, 2.00, NULL, 2),
       ((UUID_TO_BIN('a6d40ffe-99b4-44bc-9b9d-8ac6d5962180')), 1, '2023-10-19 08:40:00', 29915, 75, 84, 2.14, 7.39, 1),
       ((UUID_TO_BIN('1e929bb5-faa1-4eb0-8924-8a4123d6fb4a')), 1, '2023-10-19 16:32:00', 30111, 4, 33, 3.86, 22.72, 6),
       ((UUID_TO_BIN('fe6a7a23-1a5e-402c-b41a-30d3cea55041')), 1, '2023-10-20 02:00:00', 30147, 21, 100, 7.18, 65.24, 6),
       ((UUID_TO_BIN('2104762a-9d0e-4b09-ba0a-2e182cfd9d5f')), 1, '2023-10-20 15:20:00', 30186, 88, 98, 1.40, NULL, 6),
       ((UUID_TO_BIN('531f5fb6-692b-4afa-8fef-96bda008f981')), 1, '2023-10-20 21:00:00', 30364, 40, 100, 5.77, 52.44, 6),
       ((UUID_TO_BIN('d2818ef6-87e6-4a50-acca-7e6932a70114')), 1, '2023-10-21 01:19:00', 30589, 31, 42, 1.84, 9.71, NULL),
       ((UUID_TO_BIN('e304d9d8-dc7b-41e8-9626-ca9c8d9c21f5')), 1, '2023-10-21 13:15:00', 30592, 41, 90, 28.25, 40.96, 8),
       ((UUID_TO_BIN('ff4b6eb1-c34b-49ab-8cab-8969197bfaa8')), 1, '2023-10-21 16:40:00', 30596, 89, 95, 1.06, 5.32, NULL),
       ((UUID_TO_BIN('cc298fde-38f0-4b9d-a201-def362ff5213')), 1, '2023-10-21 22:17:00', 30827, 22, 100, 7.04, 64.00, 6),
       ((UUID_TO_BIN('138f8b5a-8553-4e6f-a38f-25a59a0b4b61')), 1, '2023-10-22 09:00:00', 30838, 97, 100, 0.40, 2.35, 6),
       ((UUID_TO_BIN('19981c91-853d-4aea-b3e8-64299669fcae')), 1, '2023-10-22 16:30:00', 31025, 37, 86, 4.00, NULL, 2),
       ((UUID_TO_BIN('57f7d7a4-1f6c-457d-a34e-2a68015a3176')), 1, '2023-10-26 07:45:00', 31191, 40, 55, 4.00, NULL, 2),
       ((UUID_TO_BIN('b1d473c4-dd08-4324-9ba9-0840a3faf091')), 1, '2023-10-26 20:30:00', 31232, 44, 60, 0.00, 13.01, NULL),
       ((UUID_TO_BIN('5436e032-ac43-4061-859b-dac0513dc360')), 1, '2023-10-27 14:15:00', 31259, 54, 58, 0.00, 3.10, 4),
       ((UUID_TO_BIN('3b0686a3-f940-4eec-a298-5e575f24a617')), 1, '2023-10-28 08:10:00', 31298, 48, 70, 0.00, 19.64, 4),
       ((UUID_TO_BIN('80a53a07-f405-4525-8c76-15c2195813f7')), 1, '2023-10-28 08:45:00', 31299, 70, 85, 0.00, NULL, 2),
       ((UUID_TO_BIN('e11de16e-d5f1-4172-b803-7c5275242ce1')), 1, '2023-11-01 07:20:00', 31410, 54, 68, 0.00, NULL, 2),
       ((UUID_TO_BIN('28bd6454-5738-4a7e-a899-be0e320bba11')), 1, '2023-11-01 15:35:00', 31426, 65, 69, 1.45, 3.70, 3),
       ((UUID_TO_BIN('8d429839-3686-4277-8a23-b94115006b59')), 1, '2023-11-02 09:35:00', 31531, 39, 67, 7.19, 24.79, 1),
       ((UUID_TO_BIN('abeb2c49-7de0-410b-b885-2311fcc8d828')), 1, '2023-11-02 11:20:00', 31531, 67, 92, 7.49, 19.21, 1),
       ((UUID_TO_BIN('74435efb-7099-4c7c-832b-6995fc7fd2c5')), 1, '2023-11-03 12:10:00', 31736, 15, 80, 5.80, 52.77, 6),
       ((UUID_TO_BIN('61f69544-2c64-44b5-a4cb-be177322bd4f')), 1, '2023-11-05 01:19:00', 31873, 35, 100, 5.80, 52.71, 6),
       ((UUID_TO_BIN('8ba03db3-cdce-4c13-b5d0-ed029aeabba3')), 1, '2023-11-05 09:30:00', 31878, 98, 100, 0.29, 1.66, 6),
       ((UUID_TO_BIN('d58b81b3-e1fb-4dac-9d3f-6440c533eda8')), 1, '2023-11-05 15:45:00', 32072, 39, 59, 4.00, NULL, 2),
       ((UUID_TO_BIN('346b20b4-48bd-481c-898e-99a270841d0d')), 1, '2023-11-06 08:05:00', 32125, 47, 54, 0.00, 6.20, 4),
       ((UUID_TO_BIN('1c1328a6-2673-4ecf-a0b6-abeae550a651')), 1, '2023-11-08 10:00:00', 32194, 36, 68, 0.00, NULL, 4),
       ((UUID_TO_BIN('0eb4580c-f07e-4242-9549-c612e677b8ec')), 1, '2023-11-10 07:45:00', 32339, 32, 44, 0.00, NULL, 2),
       ((UUID_TO_BIN('fe8afe24-cd46-40b3-b867-d6706bf0a506')), 1, '2023-11-11 14:45:00', 32432, 15, 94, 0.00, 62.97, 3),
       ((UUID_TO_BIN('96b13c50-0f83-47b8-acf1-9cdcbde79726')), 1, '2023-11-12 16:30:00', 32519, 77, 84, 0.00, NULL, NULL),
       ((UUID_TO_BIN('33f157c0-d256-4907-821c-955f6a8fa193')), 1, '2023-11-15 09:45:00', 32592, 64, 86, 0.00, NULL, 4),
       ((UUID_TO_BIN('89d59a36-4874-4a82-8c55-30db773744c1')), 1, '2023-11-17 08:15:00', 32663, 70, 96, 0.00, NULL, 4),
       ((UUID_TO_BIN('20bcebef-4438-4109-9fb6-2114e8242390')), 1, '2023-11-17 23:00:00', 32866, 21, 36, 1.38, 12.49, 6),
       ((UUID_TO_BIN('0ab4e7e8-c42d-46c8-8602-4aaaead25a25')), 1, '2023-11-18 23:00:00', 32898, 23, 39, 1.38, 12.55, 6),
       ((UUID_TO_BIN('90392adb-aa01-4895-b94a-75d69996408b')), 1, '2023-11-19 07:00:00', 32898, 39, 46, 1.00, NULL, 6),
       ((UUID_TO_BIN('644c8782-bd9e-403c-8099-5d774331b618')), 1, '2023-11-19 08:45:00', 32904, 44, 100, 7.90, 46.05, 6),
       ((UUID_TO_BIN('42556b26-2545-4555-9ce9-6f4d991d2193')), 1, '2023-11-19 16:00:00', 33110, 37, 42, 0.00, NULL, 6);
